...
struct Treap{
    ...
    /// Split t into l and r such that all elements in l is < key and all elements in r is >= than key
    ...
    /// Merge l and r into t, where all elements in l is less than all elements in r
